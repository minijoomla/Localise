...
if ($saveOrder)
{
  $saveOrderingUrl = 'index.php?option=com_localise&task=localise.saveOrderAjax&tmpl=component';
  JHtml::_('sortablelist.sortable', 'localiseList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<div id="j-sidebar-container" class="span2"> <?php echo $this->sidebar; ?>
  <div class="sidebar">
